...
<div class='container-fluid'>
    <div class='row'>
        <div class='col-12'>
            <h1 class='mb-4'><i class='fas fa-calculator me-2'></i>Simulasi Penilaian Otomatis</h1>";
...
try {
    ...
    while ($aspek = $aspek_result->fetch_assoc()) {
        ...
        while ($elemen = $elemen_result->fetch_assoc()) {
            ...
            while ($kriteria = $kriteria_result->fetch_assoc()) {
                ...
                // Distribusi: 60% nilai 2 (baik), 25% nilai 1 (kurang), 15% nilai 0 (tidak ada)
                $rand = rand(1, 100);
                if ($rand <= 15) {
                    $nilai = 0;
    ...
    echo "<div class='alert alert-info mt-4'>
        ...
        <br>
        <div class='mt-3'>
            <a href='" . BASE_URL . "pages/penilaian_detail.php?id=$penilaian_id' class='btn btn-primary me-2'><i class='fas fa-eye me-2'></i>Lihat Detail Penilaian</a>
